...
**Separadas por coma, sin espacios**: ver la advertencia 1 de [trampas.md](trampas.md). Bundles
...
| `audio` | `new Audio(...)` y `new AudioStream(...)` — ver [audio.md](audio.md) |
...
> `ux_embed`. Los permisos fetch, `spawn` y `audio` requieren además una
